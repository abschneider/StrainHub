...
#' @param columnselection Which of the metadata columns by which to summarize.
...
#' @param threshold Filter out pairs of changes between same states and also with state probabilities below a this threshold.
#'     (Default: 0.9)
#' @param threshold2 For Bayesian trees, filter out pairs of changes between same states and also with posterior probabilities below a this threshold.
#'     (Default: 0.9)
...
#' @param arrowFilled Boolean. Show filled arrow heads (`▶` vs. `>`). (Default: TRUE)
#' @param showLabels Boolean. Show location node labels. (Default: FALSE)
#' @param labelColor Hex code for label colors. (Default: "#000000")
#' @param showPoints Boolean. Show location node points. (Default: FALSE)
#' @param pointColor Hex code for point colors. (Default: "#000000")
#' @param pointOpacity Color opacity of points. Numberical value between 0 and 1. (Default: 0.5)
#############################
